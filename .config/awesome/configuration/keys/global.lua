...
local globalKeys =
  ...
  awful.key(
    ...
    'm',
    function()
      awful.util.spawn_with_shell(apps.default.music)
    end,
  ...
  awful.key(
    ...
    'b',
    function()
      awful.util.spawn(apps.default.privateBrowser)
    end,
    {description = 'Open a private tab', group = 'launcher'}
  ),
  awful.key(
    {modkey},
    'b',
  ...
  awful.key(
    ...
    {description = 'TODO', group = 'hotkeys'}
  ),
  ...
  awful.key({}, 'XF86AudioPlay',
    ...
    {description = 'Media play/pause', group = 'hotkeys'}
  ),
  awful.key({}, 'XF86AudioPrev',
    function() awful.spawn('playerctl previous') end,
    {description = 'Media previous', group = 'hotkeys'}
